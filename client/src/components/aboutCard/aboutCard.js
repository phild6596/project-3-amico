            ...
            <div className="card-profile">
                ...
                <div className="card-header"></div>
                    <div className = "card-body text-center">
                        ...
                        <h3 className="text-inherit current-user-name">{props.user.displayName}</h3>
                    </div>
                </div>
                </div>
                    ...
                    <div className="card-body">
                        <h6 className="mb-3">About</h6>
                            <ul className="list-unstyled list-spaced">
                                ...
                                <li><span className="text-muted icon glyphicon glyphicon-user mr-3"></span> UID <span className="user_props user_id"> {props.user.uid} </span></li>
                            </ul>
                    </div>
                </div>
            </div>
